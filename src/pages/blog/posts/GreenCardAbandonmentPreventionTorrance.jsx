...
const GreenCardAbandonmentPreventionTorrance = ({ language }) => {
  const content = {
    en: {
      slug: "green-card-abandonment-prevention-torrance",
      title: "Green Card Abandonment Prevention in Torrance: Protecting Your Permanent Residence",
      subtitle: "How to Maintain Your Green Card Status When Living or Working Abroad",
      metaTitle: "Green Card Abandonment Prevention Torrance | Maintain Permanent Residence Abroad",
      metaDescription: "Prevent green card abandonment while living abroad from Torrance. Re-entry permits, ties to U.S., and protecting permanent resident status. Arabic help.",
      keywords: [
        "green card abandonment Torrance",
        "maintain green card abroad",
        "re-entry permit",
        ...
        "South Bay green card"
      ],
      category: "status",
      location: "Torrance",
      region: "South Bay Los Angeles",
      targetDemographic: "Green card holders who travel or work abroad",
      date: "January 24, 2026",
      readTime: "13 min read",
      author: "SoCal Immigration Services",
      image: "/images/blog/status.jpg",
      locationIntro: "Torrance and the South Bay are home to many permanent residents who maintain business, family, or professional ties abroad. Whether you work for an international company, need to care for family overseas, or have other reasons to spend extended time outside the United States, understanding how to protect your green card from abandonment is essential.",
      summary: "A green card can be considered abandoned if you spend too much time outside the U.S. or take actions showing you've given up U.S. residence. Trips over 6 months create presumption of abandonment; trips over 1 year break continuous residence. To protect your status, apply for a re-entry permit before long trips, maintain strong U.S. ties, and file taxes as a resident. If problems occur at re-entry, knowing your rights is crucial.",
      sections: [
        {
          heading: "What Is Green Card Abandonment?",
          content: "Abandonment occurs when USCIS or CBP determines you have given up your status as a permanent resident through your actions, particularly extended time abroad.",
          list: [
        ...
        {
          heading: "Time Abroad and Abandonment Risk",
          content: "The length of your trip abroad significantly affects your risk of abandonment issues.",
          table: {
            headers: ["Trip Length", "Risk Level", "Consequences/Notes"],
            rows: [
        ...
        {
          heading: "The Re-Entry Permit",
          content: "A re-entry permit (Form I-131, category for re-entry permit) allows permanent residents to remain abroad for up to 2 years without abandoning status.",
          list: [
        ...
        {
          heading: "Maintaining U.S. Ties While Abroad",
          content: "Even with a re-entry permit, you should maintain strong ties to the United States to demonstrate your intent to return.",
          list: [
        ...
        {
          heading: "What Happens at the Port of Entry",
          content: "When returning to the U.S. after extended absence, CBP officers may question your residence and intent.",
          list: [
        ...
        {
          heading: "Form I-407: Voluntary Abandonment",
          content: "Form I-407 is a voluntary surrender of permanent resident status. Be very careful about signing this form.",
          list: [
        ...
        {
          heading: "Returning Resident Visa (SB-1)",
          content: "If you've been abroad over 2 years (or your re-entry permit expired abroad), you may need a Returning Resident Visa to return.",
          list: [
        ...
        {
          heading: "Impact on Naturalization",
          content: "Extended absences affect your eligibility for U.S. citizenship, separate from abandonment issues.",
          list: [
        ...
        },
        {
          ...
          content: "Some circumstances may provide additional protection or create additional complications.",
          list: [
        ...
        {
          heading: "Torrance and South Bay Resources",
          content: "Resources in the South Bay area can help you maintain your permanent resident status.",
          list: [
    ...
    ar: {
      slug: "green-card-abandonment-prevention-torrance",
      title: "منع التخلي عن البطاقة الخضراء في تورانس: حماية إقامتك الدائمة",
      subtitle: "كيفية الحفاظ على وضع بطاقتك الخضراء عند العيش أو العمل في الخارج",
      metaTitle: "منع التخلي عن البطاقة الخضراء تورانس | الحفاظ على الإقامة الدائمة في الخارج",
      metaDescription: "منع التخلي عن البطاقة الخضراء أثناء العيش في الخارج من تورانس. تصاريح إعادة الدخول، الروابط مع أمريكا، وحماية وضع المقيم الدائم.",
      keywords: [
        "التخلي عن البطاقة الخضراء تورانس",
        "الحفاظ على البطاقة الخضراء في الخارج",
        "تصريح إعادة الدخول"
      ],
      category: "status",
      location: "تورانس",
      region: "ساوث باي لوس أنجلوس",
      targetDemographic: "حاملو البطاقة الخضراء الذين يسافرون أو يعملون في الخارج",
      date: "24 يناير 2026",
      readTime: "13 دقيقة قراءة",
      author: "خدمات الهجرة في جنوب كاليفورنيا",
      image: "/images/blog/status.jpg",
      locationIntro: "تورانس وساوث باي موطن للعديد من المقيمين الدائمين الذين يحافظون على روابط تجارية أو عائلية أو مهنية في الخارج.",
      summary: "يمكن اعتبار البطاقة الخضراء متروكة إذا قضيت وقتاً طويلاً خارج أمريكا أو اتخذت إجراءات تظهر أنك تخليت عن الإقامة الأمريكية.",
      sections: [
        {
          heading: "ما هو التخلي عن البطاقة الخضراء؟",
          content: "يحدث التخلي عندما تقرر USCIS أو CBP أنك تخليت عن وضعك كمقيم دائم من خلال أفعالك.",
          list: [
            "البطاقة الخضراء للمقيمين الدائمين - يجب أن تنوي العيش في أمريكا",
            "الغياب الممتد يشير إلى أنك تخليت عن تلك النية",
            "يُحدد التخلي بمجمل الظروف",
            "ليس فقط حول الوقت في الخارج - أيضاً حول الروابط المحافظ عليها"
          ]
        }
      ],
      faqs: [
        {
          q: "كنت في الخارج 8 أشهر. هل سأفقد بطاقتي الخضراء؟",
...
export default GreenCardAbandonmentPreventionTorrance;
