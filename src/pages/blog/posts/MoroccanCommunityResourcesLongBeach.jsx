...
const MoroccanCommunityResourcesLongBeach = ({ language }) => {
  const content = {
    en: {
      slug: "moroccan-community-resources-long-beach",
      title: "Moroccan Community Immigration Resources in Long Beach: Support for Moroccan Families",
      subtitle: "Immigration Services and Community Support for the Moroccan-American Community in Los Angeles County",
      metaTitle: "Moroccan Community Resources Long Beach | Moroccan Immigration Support",
      metaDescription: "Immigration resources for Moroccan families in Long Beach. DV lottery, family petitions, citizenship for Moroccans. Arabic and French-speaking help.",
      keywords: [
        "Moroccan community Long Beach",
        "Moroccan immigration help",
        "Moroccan family petition",
        "Morocco DV lottery",
        "Moroccan citizenship USA",
        "Moroccan-American resources",
        "Arabic French immigration help",
        "Morocco apostille documents",
        "Moroccan dual citizenship",
        "Los Angeles Moroccan community"
      ],
      category: "community",
      location: "Long Beach",
      region: "Los Angeles County",
      targetDemographic: "Moroccan immigrants and Moroccan-Americans",
      ...
      sections: [
        {
          heading: "Morocco's Unique Position for Immigration",
          content: "Morocco has certain advantages in the U.S. immigration system that benefit Moroccan nationals.",
          list: [
        ...
        {
          heading: "Diversity Visa Lottery for Moroccans",
          content: "Morocco is consistently eligible for the annual Diversity Visa lottery, which provides 50,000 green cards to people from underrepresented countries.",
          list: [
        ...
        {
          heading: "Document Authentication: Morocco's Advantage",
          content: "Morocco joined the Hague Apostille Convention in 2016, significantly simplifying document authentication for immigration.",
          table: {
            headers: ["Document Type", "Authentication Process", "Notes"],
            rows: [
        ...
        {
          heading: "Family Immigration for Moroccans",
          content: "Family-based immigration remains the most common path for Moroccan nationals to join relatives in the United States.",
          list: [
        ...
        {
          heading: "Moroccan Dual Citizenship",
          content: "Morocco allows dual citizenship, so Moroccans can naturalize as U.S. citizens without losing Moroccan nationality.",
          list: [
        ...
        {
          heading: "Path to U.S. Citizenship for Moroccans",
          content: "Moroccan permanent residents can apply for naturalization following the standard process.",
          list: [
        ...
        },
        {
          ...
          content: "Moroccans often speak multiple languages, which affects document translation and service access.",
          list: [
        ...
        {
          heading: "Common Immigration Challenges for Moroccans",
          content: "Moroccan nationals may face specific issues in the immigration process.",
          list: [
        ...
        {
          heading: "Moroccan Consular Services",
          content: "The Moroccan Consulate provides services to nationals in the Los Angeles area.",
          list: [
        ...
        {
          heading: "Long Beach and LA Moroccan Community Resources",
          content: "The Moroccan community in Long Beach has access to cultural and practical resources.",
          list: [
    ...
    ar: {
      slug: "moroccan-community-resources-long-beach",
      title: "موارد الهجرة لمجتمع المغاربة في لونغ بيتش: دعم للعائلات المغربية",
      subtitle: "خدمات الهجرة ودعم المجتمع للمجتمع المغربي الأمريكي في مقاطعة لوس أنجلوس",
      metaTitle: "موارد المجتمع المغربي لونغ بيتش | دعم الهجرة للمغاربة",
      metaDescription: "موارد الهجرة للعائلات المغربية في لونغ بيتش. قرعة DV، التماسات العائلة، الجنسية للمغاربة. مساعدة بالعربية والفرنسية.",
      keywords: [
        "المجتمع المغربي لونغ بيتش",
        "مساعدة الهجرة للمغاربة",
        "التماس العائلة المغربية"
      ],
      category: "community",
      location: "لونغ بيتش",
      region: "مقاطعة لوس أنجلوس",
      targetDemographic: "المهاجرون المغاربة والمغاربة الأمريكيون",
      date: "24 يناير 2026",
      readTime: "12 دقيقة قراءة",
      author: "خدمات الهجرة في جنوب كاليفورنيا",
      image: "/images/blog/community.jpg",
      locationIntro: "لونغ بيتش ومنطقة لوس أنجلوس الكبرى موطن لمجتمع مغربي أمريكي نابض بالحياة. يجلب المغاربة تراثاً ثقافياً غنياً يشمل التأثيرات العربية والأمازيغية والفرنسية.",
      summary: "يستفيد المغاربة من عضوية المغرب في اتفاقية لاهاي للأبوستيل (منذ 2016)، مما يبسط مصادقة الوثائق. المغرب مؤهل لقرعة التنوع، مما يوفر مساراً إضافياً للهجرة.",
      sections: [
        {
          heading: "موقف المغرب الفريد للهجرة",
          content: "للمغرب مزايا معينة في نظام الهجرة الأمريكي تفيد المواطنين المغاربة.",
          list: [
            "مؤهل لقرعة تأشيرة التنوع (DV)",
            "عضو في اتفاقية لاهاي للأبوستيل منذ 2016",
            "المغرب يسمح بالجنسية المزدوجة مع أمريكا",
            "علاقة ثنائية قوية مع الولايات المتحدة"
          ]
        }
      ],
      faqs: [
        {
          q: "هل المغرب مؤهل لقرعة تأشيرة التنوع؟",
...
export default MoroccanCommunityResourcesLongBeach;
