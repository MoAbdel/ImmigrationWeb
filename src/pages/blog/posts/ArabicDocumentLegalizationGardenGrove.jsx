...
const ArabicDocumentLegalizationGardenGrove = ({ language }) => {
  const content = {
    en: {
      slug: "arabic-document-legalization-garden-grove",
      title: "Arabic Document Legalization in Garden Grove: Authentication for Immigration",
      subtitle: "Complete Guide to Legalizing Documents from Arab Countries for USCIS Applications",
      metaTitle: "Arabic Document Legalization Garden Grove | Arab Document Authentication USCIS",
      metaDescription: "Arabic document legalization and authentication in Garden Grove. Embassy attestation, apostille, translation for USCIS. Arabic-speaking document services.",
      keywords: [
        "Arabic document legalization Garden Grove",
        "Arab document authentication",
        "embassy attestation immigration",
        "Arabic document translation",
        "USCIS document requirements",
        "foreign document legalization",
        "Arabic birth certificate USCIS",
        "Middle East document authentication",
        "Arabic speaking document services",
        "Orange County document legalization"
      ],
      category: "documents",
      location: "Garden Grove",
      region: "Central Orange County",
      targetDemographic: "Arab immigrants needing document authentication",
      date: "January 24, 2026",
      readTime: "13 min read",
      author: "SoCal Immigration Services",
      image: "/images/blog/documents.jpg",
      locationIntro: "Garden Grove's large Arab and Middle Eastern community often needs to submit foreign documents for immigration purposes. Documents from Arab countries typically require authentication through embassy legalization since most Arab nations are not part of the Hague Apostille Convention. Understanding this process helps you prepare proper documentation for USCIS applications.",
      summary: "Documents from most Arab countries require embassy legalization (not apostille) before USCIS will accept them. The process involves authentication in the country of origin, legalization at the embassy of that country in the U.S., and certified translation into English. Different document types (birth certificates, marriage certificates, educational records) may have different requirements.",
      sections: [
        {
          heading: "Apostille vs. Embassy Legalization",
          content: "The authentication process depends on whether your document's country of origin is part of the Hague Apostille Convention.",
          table: {
            headers: ["Process Type", "Countries", "Steps Required"],
            rows: [
        ...
        {
          heading: "Arab Countries and Document Authentication",
          content: "Most Arab countries are NOT part of the Hague Apostille Convention and require embassy legalization.",
          table: {
            headers: ["Country", "Hague Member?", "Authentication Process"],
            rows: [
        ...
        {
          heading: "The Embassy Legalization Process",
          content: "For countries requiring embassy legalization, documents must go through multiple steps before being accepted by USCIS.",
          steps: [
            { title: "Original document issued", description: "Birth certificate, marriage certificate, etc. from issuing authority" },
            { title: "Authentication in country", description: "Foreign Ministry or other designated authority authenticates document" },
            { title: "Embassy legalization in U.S.", description: "Document presented to country's embassy/consulate for legalization" },
            { title: "Certified translation", description: "Translate document into English with translator certification" },
            { title: "Submit to USCIS", description: "Legalized document + translation submitted with immigration application" }
          ]
        },
        {
          heading: "Document Types and Special Requirements",
          content: "Different documents may have different authentication paths depending on the issuing authority.",
          list: [
        ...
        {
          heading: "Translation Requirements for USCIS",
          content: "All documents in languages other than English must be accompanied by certified English translations.",
          list: [
        ...
        {
          heading: "Embassy Locations for Arab Countries",
          content: "You'll need to contact the embassy or consulate of your document's country. Most are in Washington D.C. with some consulates in Los Angeles.",
          list: [
        ...
        {
          heading: "Processing Times and Costs",
          content: "Embassy legalization takes time and involves fees. Plan ahead for your immigration application deadlines.",
          list: [
        ...
        },
        {
          ...
          content: "Document legalization doesn't always go smoothly. Here are common issues and how to address them.",
          list: [
        ...
        {
          heading: "What If You Can't Get Documents from Your Home Country?",
          content: "War, persecution, or other circumstances may prevent obtaining or authenticating documents. USCIS has provisions for these situations.",
          list: [
        ...
        {
          heading: "Garden Grove and Orange County Resources",
          content: "Local resources can help with document legalization for Arab immigrants.",
          list: [
    ...
    ar: {
      slug: "arabic-document-legalization-garden-grove",
      title: "تصديق الوثائق العربية في غاردن غروف: المصادقة للهجرة",
      subtitle: "دليل شامل لتصديق الوثائق من البلدان العربية لطلبات USCIS",
      metaTitle: "تصديق الوثائق العربية غاردن غروف | مصادقة الوثائق العربية USCIS",
      metaDescription: "تصديق ومصادقة الوثائق العربية في غاردن غروف. تصديق السفارة، الترجمة لـ USCIS. خدمات وثائق بالعربية.",
      keywords: [
        "تصديق الوثائق العربية غاردن غروف",
        "مصادقة الوثائق العربية",
        "تصديق السفارة للهجرة"
      ],
      category: "documents",
      location: "غاردن غروف",
      region: "وسط مقاطعة أورانج",
      targetDemographic: "المهاجرون العرب الذين يحتاجون مصادقة الوثائق",
      date: "24 يناير 2026",
      readTime: "13 دقيقة قراءة",
      author: "خدمات الهجرة في جنوب كاليفورنيا",
      image: "/images/blog/documents.jpg",
      locationIntro: "مجتمع غاردن غروف العربي الكبير غالباً ما يحتاج إلى تقديم وثائق أجنبية لأغراض الهجرة. الوثائق من البلدان العربية تتطلب عادةً تصديق السفارة.",
      summary: "الوثائق من معظم البلدان العربية تتطلب تصديق السفارة (وليس الأبوستيل) قبل أن يقبلها USCIS. تتضمن العملية المصادقة في بلد المنشأ، التصديق في سفارة ذلك البلد في أمريكا، والترجمة المعتمدة إلى الإنجليزية.",
      sections: [
        {
          heading: "الأبوستيل مقابل تصديق السفارة",
          content: "تعتمد عملية المصادقة على ما إذا كان بلد منشأ وثيقتك جزءاً من اتفاقية لاهاي للأبوستيل.",
          list: [
            "معظم البلدان العربية ليست جزءاً من اتفاقية لاهاي",
            "مصر، الأردن، لبنان، سوريا، العراق تتطلب تصديق السفارة",
            "المغرب وعمان أعضاء في لاهاي (الأبوستيل متاح)",
            "السعودية والإمارات تتطلب تصديق السفارة"
          ]
        }
      ],
      faqs: [
        {
          q: "بلدي ليس جزءاً من اتفاقية لاهاي. ماذا أفعل؟",
...
export default ArabicDocumentLegalizationGardenGrove;
