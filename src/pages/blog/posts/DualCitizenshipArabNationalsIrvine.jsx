...
const DualCitizenshipArabNationalsIrvine = ({ language }) => {
  const content = {
    en: {
      slug: "dual-citizenship-arab-nationals-irvine",
      title: "Dual Citizenship for Arab Nationals in Irvine: Can You Keep Your Original Citizenship?",
      subtitle: "Understanding Dual Nationality Rules for Egyptian, Lebanese, Jordanian, and Other Arab Immigrants",
      metaTitle: "Dual Citizenship Arab Nationals Irvine | Keep Original Citizenship After Naturalization",
      metaDescription: "Dual citizenship options for Arab nationals in Irvine. Whether Egyptians, Jordanians, Lebanese can keep original citizenship after U.S. naturalization.",
      keywords: [
        "dual citizenship Arab nationals Irvine",
        "Egyptian dual citizenship",
        "Jordanian dual citizenship",
        "Lebanese dual citizenship",
        "U.S. naturalization keep citizenship",
        "Arab immigrants citizenship",
        "dual nationality rules",
        "original citizenship after naturalization",
        "Arabic-speaking citizenship help",
        "Orange County naturalization"
      ],
      category: "citizenship",
      location: "Irvine",
      region: "South Orange County",
      targetDemographic: "Arab immigrants considering naturalization",
      date: "January 24, 2026",
      readTime: "13 min read",
      author: "SoCal Immigration Services",
      image: "/images/blog/citizenship.jpg",
      locationIntro: "Irvine's professional Arab community includes many immigrants who have built successful lives in the United States while maintaining strong ties to their home countries. When considering U.S. citizenship, a common question is whether you can keep your original citizenship. The answer depends on both U.S. law (which generally permits dual citizenship) and your home country's laws, which vary significantly among Arab nations.",
      summary: "The United States does not require you to give up your original citizenship when naturalizing. However, your home country's laws determine whether you can maintain dual citizenship. Some Arab countries (like Lebanon and Syria) permit dual citizenship, while others (like Saudi Arabia and UAE) generally do not. Understanding both sets of laws is essential before making this important decision.",
      sections: [
        {
          heading: "U.S. Position on Dual Citizenship",
          content: "The United States generally permits dual citizenship, though it does not actively encourage it. Understanding the U.S. position is the starting point.",
          list: [
        ...
        {
          heading: "Dual Citizenship by Arab Country",
          content: "Each Arab country has its own laws regarding dual citizenship. Here's what nationals from major Arab countries need to know.",
          table: {
            headers: ["Country", "Dual Citizenship Allowed?", "Notes"],
            rows: [
        ...
        {
          heading: "Egypt: Dual Citizenship with Notification",
          content: "Egyptian citizens can hold dual citizenship but must follow specific procedures. Failure to notify can have consequences.",
          list: [
        ...
        {
          heading: "Lebanon: Dual Citizenship Fully Permitted",
          content: "Lebanon is one of the most accommodating Arab countries for dual citizenship. Lebanese Americans can maintain both nationalities freely.",
          list: [
        ...
        {
          heading: "Jordan: Dual Citizenship with Conditions",
          content: "Jordan permits dual citizenship but Jordanian citizenship comes with obligations that must be maintained.",
          list: [
        ...
        {
          heading: "Gulf Countries: Generally No Dual Citizenship",
          content: "Most Gulf Cooperation Council (GCC) countries do not permit dual citizenship. Naturalized U.S. citizens typically must renounce Gulf citizenship.",
          list: [
        ...
        {
          heading: "Practical Considerations for Dual Citizens",
          content: "If your country permits dual citizenship, there are practical matters to consider when holding two nationalities.",
          list: [
        ...
        {
          heading: "The Naturalization Oath",
          content: "The U.S. naturalization oath includes language about renouncing foreign allegiances. Understanding what this means in practice is important.",
          list: [
        ...
        {
          heading: "Impact on Travel to Home Country",
          content: "Dual citizenship affects how you can travel to your country of origin. Plan accordingly.",
          list: [
        ...
        {
          heading: "Irvine Resources for Naturalization",
          content: "Irvine and Orange County have resources for immigrants considering naturalization.",
          list: [
      ...
      disclaimer: "This article provides general information about dual citizenship for Arab nationals in Irvine and does not constitute legal advice. Laws regarding dual citizenship vary by country and change frequently. SoCal Immigration Services is a document preparation company, not a law firm. For legal advice about your specific situation, especially regarding your home country's citizenship laws, consult with qualified legal counsel in both the United States and your country of origin.",
      cta: {
        title: "Need Citizenship Help in Irvine?",
        text: "Our team assists with N-400 naturalization applications, document preparation, and citizenship test prep.",
        button: "Get Started Today"
      }
    },
    ar: {
      slug: "dual-citizenship-arab-nationals-irvine",
      title: "الجنسية المزدوجة للمواطنين العرب في إيرفين: هل يمكنك الاحتفاظ بجنسيتك الأصلية؟",
      subtitle: "فهم قواعد الجنسية المزدوجة للمصريين واللبنانيين والأردنيين وغيرهم من المهاجرين العرب",
      metaTitle: "الجنسية المزدوجة للمواطنين العرب إيرفين | الاحتفاظ بالجنسية الأصلية بعد التجنس",
      metaDescription: "خيارات الجنسية المزدوجة للمواطنين العرب في إيرفين. هل يمكن للمصريين والأردنيين واللبنانيين الاحتفاظ بجنسيتهم الأصلية بعد التجنس الأمريكي.",
      keywords: [
        "الجنسية المزدوجة للمواطنين العرب إيرفين",
        "الجنسية المزدوجة المصرية",
        "الجنسية المزدوجة الأردنية"
      ],
      category: "citizenship",
      location: "إيرفين",
      region: "جنوب مقاطعة أورانج",
      targetDemographic: "المهاجرون العرب الذين يفكرون في التجنس",
      date: "24 يناير 2026",
      readTime: "13 دقيقة قراءة",
      author: "خدمات الهجرة في جنوب كاليفورنيا",
      image: "/images/blog/citizenship.jpg",
      locationIntro: "يضم مجتمع إيرفين العربي المهني العديد من المهاجرين الذين بنوا حياة ناجحة في الولايات المتحدة مع الحفاظ على روابط قوية مع بلدانهم الأصلية.",
      summary: "لا تتطلب الولايات المتحدة منك التخلي عن جنسيتك الأصلية عند التجنس. ومع ذلك، تحدد قوانين بلدك الأصلي ما إذا كان يمكنك الحفاظ على الجنسية المزدوجة.",
      sections: [
        {
          heading: "موقف الولايات المتحدة من الجنسية المزدوجة",
          content: "تسمح الولايات المتحدة عموماً بالجنسية المزدوجة، على الرغم من أنها لا تشجعها بنشاط.",
          list: [
            "القانون الأمريكي لا يتطلب التخلي عن الجنسية الأخرى",
            "يمكنك حمل جواز السفر الأمريكي وجواز السفر الأجنبي في نفس الوقت",
            "يجب استخدام جواز السفر الأمريكي للدخول والخروج من الولايات المتحدة",
            "الجنسية الأجنبية لا تؤثر على جنسيتك الأمريكية"
          ]
        }
      ],
      faqs: [
        {
          q: "هل ستخبر الولايات المتحدة بلدي الأصلي أنني تجنست؟",
          a: "لا، الولايات المتحدة لا تخطر الحكومات الأجنبية عندما يتجنس مواطنوها. ومع ذلك، إذا كان لبلدك الأصلي قيود على الجنسية المزدوجة، قد يعلمون من خلال وسائل أخرى."
        }
      ],
      disclaimer: "تقدم هذه المقالة معلومات عامة حول الجنسية المزدوجة للمواطنين العرب في إيرفين ولا تشكل مشورة قانونية.",
      cta: {
        title: "هل تحتاج مساعدة في الجنسية في إيرفين؟",
        text: "فريقنا يساعد في طلبات التجنس N-400 وإعداد الوثائق والتحضير لاختبار الجنسية.",
        button: "ابدأ اليوم"
      }
    }
  };
...
export default DualCitizenshipArabNationalsIrvine;
