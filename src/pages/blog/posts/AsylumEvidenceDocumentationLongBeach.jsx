...
const AsylumEvidenceDocumentationLongBeach = ({ language }) => {
  const content = {
    en: {
      slug: "asylum-evidence-documentation-long-beach",
      title: "Asylum Evidence and Documentation in Long Beach: Building a Strong Case",
      subtitle: "Complete Guide to Gathering Evidence for Asylum Applications in Los Angeles County",
      metaTitle: "Asylum Evidence Documentation Long Beach | Asylum Proof Requirements",
      metaDescription: "How to document and gather evidence for asylum in Long Beach. Country conditions, personal testimony, and supporting documents. Arabic-speaking asylum help.",
      keywords: [
        "asylum evidence Long Beach",
        "asylum documentation requirements",
        "country conditions evidence",
        "asylum case proof",
        "persecution evidence",
        "asylum application documents",
        "I-589 supporting evidence",
        "asylum interview preparation",
        "Arabic asylum help",
        "Los Angeles County asylum"
      ],
      category: "asylum",
      location: "Long Beach",
      region: "Los Angeles County",
      targetDemographic: "Asylum seekers preparing applications",
      date: "January 24, 2026",
      readTime: "16 min read",
      author: "SoCal Immigration Services",
      image: "/images/blog/asylum.jpg",
      locationIntro: "Long Beach, one of the most diverse cities in Southern California, is home to asylum seekers from around the world including many from the Middle East. Building a strong asylum case requires thorough documentation of both your personal persecution and the conditions in your home country. The evidence you gather can make the difference between approval and denial. This guide explains what evidence you need and how to obtain it.",
      summary: "A successful asylum case requires three types of evidence: personal testimony (your declaration), corroborating evidence (documents supporting your story), and country conditions evidence (showing persecution is real in your country). Strong cases combine all three. Evidence should be organized, translated, and presented clearly to asylum officers or immigration judges.",
      sections: [
        {
          heading: "The Three Pillars of Asylum Evidence",
          content: "Asylum cases are built on three foundational types of evidence. Your case needs all three to be considered strong.",
          table: {
            headers: ["Evidence Type", "What It Proves", "Examples"],
            rows: [
        ...
        {
          heading: "Your Personal Declaration",
          content: "The personal declaration (also called personal statement or affidavit) is the foundation of your asylum case. It tells your story in your own words.",
          list: [
        ...
        {
          heading: "Writing an Effective Declaration",
          content: "Your declaration should be detailed enough to paint a complete picture but organized enough to follow easily. Follow these guidelines.",
          steps: [
            { title: "Background section", description: "Your identity, family, religion, ethnicity, political opinion - the basis for persecution" },
            { title: "First incident", description: "Describe the first time you experienced persecution in detail" },
            { title: "Subsequent incidents", description: "Each additional incident with dates, perpetrators, and your response" },
            { title: "Pattern of persecution", description: "Show how incidents connect and escalate" },
            { title: "Harm to others", description: "Describe what happened to family, friends, community members" },
            { title: "Reporting attempts", description: "Explain any attempts to get help and the response (or lack thereof)" },
            { title: "Decision to flee", description: "What made you decide to leave your country" },
            { title: "Journey to U.S.", description: "How you traveled here and through which countries" },
            { title: "Fear of return", description: "Why you cannot safely return today" },
            { title: "Signature and oath", description: "Sign under penalty of perjury that everything is true" }
          ]
        },
        {
          heading: "Corroborating Documents",
          content: "Documents that support your story add credibility. USCIS expects corroboration for claims that can reasonably be documented.",
          list: [
        ...
        },
        {
          ...
          content: "Country conditions evidence shows that persecution of people like you is real and ongoing in your home country. Official sources carry the most weight.",
          list: [
        ...
        {
          heading: "What If You Don't Have Documents?",
          content: "Many asylum seekers flee without documents or cannot obtain them safely. The law recognizes this reality.",
          list: [
        ...
        {
          heading: "Affidavits from Witnesses",
          content: "Letters from people who know about your persecution or can attest to your character strengthen your case. These should be sworn statements.",
          list: [
        ...
        {
          heading: "Translation Requirements",
          content: "All documents in languages other than English must be translated. Translations must meet specific requirements.",
          list: [
        ...
        {
          heading: "Organizing Your Evidence Package",
          content: "A well-organized evidence package makes it easier for the asylum officer or judge to follow your case and find supporting documents.",
          steps: [
            { title: "Create index/table of contents", description: "List every document with tab numbers or page references" },
            { title: "Tab dividers", description: "Separate sections with labeled tabs" },
            { title: "Chronological order", description: "Organize events and evidence in time sequence" },
            { title: "Group by type", description: "Personal documents, country conditions, affidavits" },
            { title: "Highlight key passages", description: "Mark important sections in long documents" },
            { title: "Cover page", description: "Your name, A-number, case type" },
            { title: "Make copies", description: "Keep complete copies for yourself" }
          ]
        },
        {
          heading: "Long Beach and LA County Resources",
          content: "Long Beach has resources to help asylum seekers gather evidence and prepare their cases.",
          list: [
    ...
    ar: {
      slug: "asylum-evidence-documentation-long-beach",
      title: "أدلة ووثائق اللجوء في لونغ بيتش: بناء قضية قوية",
      subtitle: "دليل شامل لجمع الأدلة لطلبات اللجوء في مقاطعة لوس أنجلوس",
      metaTitle: "توثيق أدلة اللجوء لونغ بيتش | متطلبات إثبات اللجوء",
      metaDescription: "كيفية توثيق وجمع الأدلة للجوء في لونغ بيتش. ظروف البلد، الشهادة الشخصية، والوثائق الداعمة. مساعدة لجوء بالعربية.",
      keywords: [
        "أدلة اللجوء لونغ بيتش",
        "متطلبات توثيق اللجوء",
        "أدلة ظروف البلد"
      ],
      category: "asylum",
      location: "لونغ بيتش",
      region: "مقاطعة لوس أنجلوس",
      targetDemographic: "طالبو اللجوء الذين يحضرون طلباتهم",
      date: "24 يناير 2026",
      readTime: "16 دقيقة قراءة",
      author: "خدمات الهجرة في جنوب كاليفورنيا",
      image: "/images/blog/asylum.jpg",
      locationIntro: "لونغ بيتش، واحدة من أكثر المدن تنوعاً في جنوب كاليفورنيا، موطن لطالبي اللجوء من جميع أنحاء العالم. بناء قضية لجوء قوية يتطلب توثيقاً شاملاً.",
      summary: "تتطلب قضية اللجوء الناجحة ثلاثة أنواع من الأدلة: الشهادة الشخصية، الأدلة المؤيدة، وأدلة ظروف البلد. القضايا القوية تجمع بين الثلاثة.",
      sections: [
        {
          heading: "الركائز الثلاث لأدلة اللجوء",
          content: "تُبنى قضايا اللجوء على ثلاثة أنواع أساسية من الأدلة. قضيتك تحتاج الثلاثة لتُعتبر قوية.",
          list: [
            "الشهادة الشخصية: ما حدث لك تحديداً",
            "الأدلة المؤيدة: قصتك صحيحة وقابلة للتحقق",
            "ظروف البلد: الاضطهاد موجود في بلدك"
          ]
        }
      ],
      faqs: [
        {
          q: "كم يجب أن يكون طول إفادتي الشخصية؟",
...
export default AsylumEvidenceDocumentationLongBeach;
